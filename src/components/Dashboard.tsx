    ...
    <div className="space-y-6 bg-slate-100/50 p-6 rounded-2xl border border-slate-200" id="main-dashboard-wrap">
      ...
      {activeStopsAlerts.length > 0 && (
        <motion.div 
          ...
          className="bg-red-50 border-l-4 border-red-500 p-4 rounded-r-xl shadow-xs flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 animate-pulse"
        >
